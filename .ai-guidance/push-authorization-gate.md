...
| Date | Incident |
|------|----------|
| 2026-03-27 | Agent pushed 4 branches to work CI, triggering pipeline runs without human approval. Unsanctioned code deployed. PRs abandoned/restored, pipeline runs deleted, guardrails created (this section + `push-authorization-gate` skill + workflow templates). |
