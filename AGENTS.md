...
| **[COMPANY] / Azure DevOps** (`dev.azure.com/[COMPANY]/*`, `gitlab.int.internal.example.net/*`) | Work | [COMPANY] identity | [COMPANY] user |

- ❌ **NEVER** use the [COMPANY] identity for ANY public GitHub operation (commits, PRs, pushes, comments)
- ❌ **NEVER** configure [COMPANY] email in repos under `Personal/` or any `github.com` remote
